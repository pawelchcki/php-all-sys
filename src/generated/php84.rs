...
pub const PHP_API_VERSION: u32 = 20240924;
...
pub const PHP_RELEASE_VERSION: u32 = 23;
pub const PHP_EXTRA_VERSION: &'static [u8; 1usize] = b"\0";
pub const PHP_VERSION: &'static [u8; 7usize] = b"8.4.23\0";
pub const PHP_VERSION_ID: u32 = 80423;
pub const ZEND_VERSION: &'static [u8; 7usize] = b"4.4.23\0";
...
pub const ZEND_VM_LAST_OPCODE: u32 = 209;
...
pub const PHP_EXTENSION_DIR: &'static [u8; 22usize] = b"/usr/lib/php/20240924\0";
...
pub const PHP_DATADIR: &'static [u8; 19usize] = b"/usr/share/php/8.4\0";
pub const PHP_SYSCONFDIR: &'static [u8; 5usize] = b"/etc\0";
pub const PHP_LOCALSTATEDIR: &'static [u8; 5usize] = b"/var\0";
pub const PHP_CONFIG_FILE_PATH: &'static [u8; 17usize] = b"/etc/php/8.4/cli\0";
pub const PHP_CONFIG_FILE_SCAN_DIR: &'static [u8; 24usize] = b"/etc/php/8.4/cli/conf.d\0";
...
pub const ZEND_EXTENSION_API_NO: u32 = 420240924;
...
extern "C" {
    pub fn zend_class_can_be_lazy(ce: *mut zend_class_entry) -> bool;
}
extern "C" {
...
extern "C" {
    pub fn zend_lazy_object_get_flags(obj: *mut zend_object) -> zend_lazy_object_flags_t;
}
extern "C" {
    pub fn zend_lazy_object_del_info(obj: *mut zend_object);
}
extern "C" {
...
extern "C" {
    pub fn zend_lazy_object_decr_lazy_props(obj: *mut zend_object) -> bool;
}
extern "C" {
...
fn bindgen_test_layout__zend_oparray_context() {
    ...
    assert_eq!(
        unsafe {
            &(*(::std::ptr::null::<_zend_oparray_context>())).active_property_info as *const _
                as usize
        },
        64usize,
        concat!(
            ...
            stringify!(_zend_oparray_context),
            "::",
            stringify!(active_property_info)
        )
    );
    assert_eq!(
        unsafe {
...
pub const ZEND_MODULE_BUILD_ID_: &'static [u8; 16usize] = b"API20240924,NTS\0";
