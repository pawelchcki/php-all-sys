...
pub const PHP_VERSION: &[u8; 7] = b"8.1.34\0";
pub const PHP_VERSION_ID: u32 = 80134;
pub const ZEND_VERSION: &[u8; 7] = b"4.1.34\0";
...
pub const ZEND_EXTENSION_API_NO: u32 = 420210902;
...
const _: () = {
    ["Size of _zend_class_mutable_data"]
        [::std::mem::size_of::<_zend_class_mutable_data>() - 24usize];
...
#[allow(clippy::unnecessary_operation, clippy::identity_op)]
const _: () = {
    ["Size of _zend_class_entry"][::std::mem::size_of::<_zend_class_entry>() - 496usize];
    ...
    ["Offset of field: _zend_class_entry::get_iterator"]
        [::std::mem::offset_of!(_zend_class_entry, get_iterator) - 376usize];
    ["Offset of field: _zend_class_entry::get_static_method"]
        [::std::mem::offset_of!(_zend_class_entry, get_static_method) - 384usize];
    ["Offset of field: _zend_class_entry::serialize"]
        [::std::mem::offset_of!(_zend_class_entry, serialize) - 392usize];
    ["Offset of field: _zend_class_entry::unserialize"]
        [::std::mem::offset_of!(_zend_class_entry, unserialize) - 400usize];
    ["Offset of field: _zend_class_entry::num_interfaces"]
        [::std::mem::offset_of!(_zend_class_entry, num_interfaces) - 408usize];
    ["Offset of field: _zend_class_entry::num_traits"]
        [::std::mem::offset_of!(_zend_class_entry, num_traits) - 412usize];
    ["Offset of field: _zend_class_entry::trait_names"]
        [::std::mem::offset_of!(_zend_class_entry, trait_names) - 424usize];
    ["Offset of field: _zend_class_entry::trait_aliases"]
        [::std::mem::offset_of!(_zend_class_entry, trait_aliases) - 432usize];
    ["Offset of field: _zend_class_entry::trait_precedences"]
        [::std::mem::offset_of!(_zend_class_entry, trait_precedences) - 440usize];
    ["Offset of field: _zend_class_entry::attributes"]
        [::std::mem::offset_of!(_zend_class_entry, attributes) - 448usize];
    ["Offset of field: _zend_class_entry::enum_backing_type"]
        [::std::mem::offset_of!(_zend_class_entry, enum_backing_type) - 456usize];
    ["Offset of field: _zend_class_entry::backed_enum_table"]
        [::std::mem::offset_of!(_zend_class_entry, backed_enum_table) - 464usize];
    ["Offset of field: _zend_class_entry::info"]
        [::std::mem::offset_of!(_zend_class_entry, info) - 472usize];
};
#[repr(C)]
#[derive(Debug, Copy, Clone)]
...
#[allow(clippy::unnecessary_operation, clippy::identity_op)]
const _: () = {
    ["Size of _zend_executor_globals"][::std::mem::size_of::<_zend_executor_globals>() - 1752usize];
    ...
    ["Offset of field: _zend_executor_globals::exception_ignore_args"]
        [::std::mem::offset_of!(_zend_executor_globals, exception_ignore_args) - 1616usize];
    ...
    ["Offset of field: _zend_executor_globals::get_gc_buffer"]
        [::std::mem::offset_of!(_zend_executor_globals, get_gc_buffer) - 1632usize];
    ["Offset of field: _zend_executor_globals::main_fiber_context"]
        [::std::mem::offset_of!(_zend_executor_globals, main_fiber_context) - 1656usize];
    ["Offset of field: _zend_executor_globals::current_fiber_context"]
        [::std::mem::offset_of!(_zend_executor_globals, current_fiber_context) - 1664usize];
    ["Offset of field: _zend_executor_globals::active_fiber"]
        [::std::mem::offset_of!(_zend_executor_globals, active_fiber) - 1672usize];
    ["Offset of field: _zend_executor_globals::fiber_stack_size"]
        [::std::mem::offset_of!(_zend_executor_globals, fiber_stack_size) - 1680usize];
    ["Offset of field: _zend_executor_globals::record_errors"]
        [::std::mem::offset_of!(_zend_executor_globals, record_errors) - 1688usize];
    ["Offset of field: _zend_executor_globals::num_errors"]
        [::std::mem::offset_of!(_zend_executor_globals, num_errors) - 1692usize];
    ["Offset of field: _zend_executor_globals::errors"]
        [::std::mem::offset_of!(_zend_executor_globals, errors) - 1696usize];
    ["Offset of field: _zend_executor_globals::reserved"]
        [::std::mem::offset_of!(_zend_executor_globals, reserved) - 1704usize];
};
#[repr(C)]
#[derive(Debug, Copy, Clone)]
...
#[allow(clippy::unnecessary_operation, clippy::identity_op)]
const _: () = {
    ["Size of _php_core_globals"][::std::mem::size_of::<_php_core_globals>() - 664usize];
...
pub const ZEND_MODULE_BUILD_ID_: &[u8; 16] = b"API20210902,NTS\0";
