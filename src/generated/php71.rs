...
pub const PHP_UNAME : & 'static [u8 ; 98usize] = b"Linux calcifer.rfc1925.org 4.19.0-13-amd64 #1 SMP Debian 4.19.160-2 (2020-11-28) x86_64 GNU/Linux\0" ;
...
pub const PHP_EXTRA_VERSION: &'static [u8; 38usize] = b"-34+0~20210223.52+debian9~1.gbpb1fb69\0";
pub const PHP_VERSION: &'static [u8; 44usize] = b"7.1.33-34+0~20210223.52+debian9~1.gbpb1fb69\0";
pub const PHP_VERSION_ID: u32 = 70133;
pub const ZEND_VERSION: &'static [u8; 6usize] = b"3.1.0\0";
...
pub const PHP_EXTENSION_DIR: &'static [u8; 22usize] = b"/usr/lib/php/20160303\0";
...
pub const PHP_DATADIR: &'static [u8; 19usize] = b"/usr/share/php/7.1\0";
pub const PHP_SYSCONFDIR: &'static [u8; 5usize] = b"/etc\0";
pub const PHP_LOCALSTATEDIR: &'static [u8; 5usize] = b"/var\0";
pub const PHP_CONFIG_FILE_PATH: &'static [u8; 17usize] = b"/etc/php/7.1/cli\0";
pub const PHP_CONFIG_FILE_SCAN_DIR: &'static [u8; 24usize] = b"/etc/php/7.1/cli/conf.d\0";
...
fn bindgen_test_layout__zend_compiler_globals() {
    ...
    assert_eq!(
        unsafe {
            &(*(::std::ptr::null::<_zend_compiler_globals>())).known_strings as *const _ as usize
        },
        2480usize,
        concat!(
            "Offset of field: ",
            stringify!(_zend_compiler_globals),
            "::",
            stringify!(known_strings)
        )
    );
    assert_eq!(
        unsafe {
            &(*(::std::ptr::null::<_zend_compiler_globals>())).known_strings_count as *const _
                as usize
        },
        2488usize,
        concat!(
...
pub const ZEND_MODULE_BUILD_ID_: &'static [u8; 16usize] = b"API20160303,NTS\0";
