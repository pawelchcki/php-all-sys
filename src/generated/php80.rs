...
pub const PHP_VERSION: &'static [u8; 6usize] = b"8.0.2\0";
pub const PHP_VERSION_ID: u32 = 80002;
pub const ZEND_VERSION: &'static [u8; 6usize] = b"4.0.2\0";
...
pub const MAY_BE_ARRAY_HASH: u32 = 4194304;
...
pub const PHP_EXTENSION_DIR: &'static [u8; 22usize] = b"/usr/lib/php/20200930\0";
...
pub const PHP_DATADIR: &'static [u8; 19usize] = b"/usr/share/php/8.0\0";
pub const PHP_SYSCONFDIR: &'static [u8; 5usize] = b"/etc\0";
pub const PHP_LOCALSTATEDIR: &'static [u8; 5usize] = b"/var\0";
pub const PHP_CONFIG_FILE_PATH: &'static [u8; 17usize] = b"/etc/php/8.0/cli\0";
pub const PHP_CONFIG_FILE_SCAN_DIR: &'static [u8; 24usize] = b"/etc/php/8.0/cli/conf.d\0";
...
extern "C" {
    pub fn zend_set_memory_limit(memory_limit: size_t);
}
extern "C" {
...
#[test]
fn bindgen_test_layout_zend_lexer_ident_ref() {
    assert_eq!(
        ::std::mem::size_of::<zend_lexer_ident_ref>(),
        8usize,
        concat!("Size of: ", stringify!(zend_lexer_ident_ref))
    );
    assert_eq!(
        ::std::mem::align_of::<zend_lexer_ident_ref>(),
        4usize,
        concat!("Alignment of ", stringify!(zend_lexer_ident_ref))
    );
    assert_eq!(
        unsafe { &(*(::std::ptr::null::<zend_lexer_ident_ref>())).offset as *const _ as usize },
        0usize,
        concat!(
            "Offset of field: ",
            stringify!(zend_lexer_ident_ref),
            "::",
            stringify!(offset)
        )
    );
    assert_eq!(
        unsafe { &(*(::std::ptr::null::<zend_lexer_ident_ref>())).len as *const _ as usize },
        4usize,
        concat!(
            "Offset of field: ",
            stringify!(zend_lexer_ident_ref),
...
pub union _zend_function {
    ...
    _bindgen_union_align: [u64; 29usize],
}
#[repr(C)]
#[derive(Debug, Copy, Clone)]
...
extern "C" {
    pub fn zend_is_auto_global_str(name: *const ::std::os::raw::c_char, len: size_t) -> zend_bool;
}
extern "C" {
...
fn bindgen_test_layout__zend_output_globals() {
    ...
    assert_eq!(
        unsafe {
            &(*(::std::ptr::null::<_zend_output_globals>())).output_start_filename_str as *const _
                as usize
        },
        56usize,
        concat!(
            ...
            stringify!(_zend_output_globals),
            "::",
            stringify!(output_start_filename_str)
        )
    );
}
...
pub const ZEND_MODULE_BUILD_ID_: &'static [u8; 16usize] = b"API20200930,NTS\0";
